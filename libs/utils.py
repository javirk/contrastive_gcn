...
class EarlyStopping:
    ...
    def __init__(self, config):
        ...
        """
        self.patience = config['early_stopping_kwargs']['patience']
        self.min_delta = config['early_stopping_kwargs']['min_delta']
        self.counter = 0
        self.best_loss = None
    ...
    def __call__(self, val_loss):
        if self.best_loss is None:
            ...
            print(f'Best loss: {self.best_loss}, Val loss: {val_loss}')
            self.counter += 1
